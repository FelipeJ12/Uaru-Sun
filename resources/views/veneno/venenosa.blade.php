...
$items = [
        ...
        ['label' => 'Plantas Venenosas'] // Última miga
    ];

    $title = 'Plantas Venenosas'; 
@endphp


@extends('layouts.app')

@section('title', 'Plantas Venenosas')
...
@section('content')
    ...
    <!-- Menú desplegable -->
    @if($especies->isEmpty())
        <p class="text-white text-center">No hay especies registradas en planatas Venenosas.</p>
    @else
