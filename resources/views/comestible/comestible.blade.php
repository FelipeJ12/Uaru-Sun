...
$items = [
        ...
        ['label' => 'Plantas Comestible'] // Última miga
    ];

    $title = 'Plantas Comestible'; 
@endphp


@extends('layouts.app')

@section('title', 'Plantas Comestible')
...
@section('content')
    ...
    <!-- Menú desplegable -->
    @if($especies->isEmpty())
        <p class="text-white text-center">No Hay Regidtros en Planatas Comestibles.</p>
    @else
