...
$title = 'Editar Enfermedad en Planta'; 
@endphp
...
<div class="form-container">
    ...
    <form action="{{ route('enfermedades.update', $enfermedad->id) }}" method="POST" enctype="multipart/form-data" novalidate>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="nombre_planta" name="nombre_planta" required value="{{ old('nombre_planta', $enfermedad->nombre_planta) }}">
            @error('nombre_planta')
        ...
        <div class="mb-4">
            ...
            <input type="text" id="nombre_enfermedad" name="nombre_enfermedad" required value="{{ old('nombre_enfermedad', $enfermedad->nombre_enfermedad) }}">
        ...
        <div class="mb-4">
            ...
            <textarea id="causas" name="causas">{{ old('causas', $enfermedad->causas) }}</textarea>
            @error('causas')
                <small class="text-danger">{{ $message }}</small>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <textarea id="solucion" name="solucion" required>{{ old('solucion', $enfermedad->solucion) }}</textarea>
            @error('solucion')
                <small class="text-danger">{{ $message }}</small>
            @enderror
        </div>
