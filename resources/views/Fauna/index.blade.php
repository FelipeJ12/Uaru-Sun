...
<div class="container">
    <style>
        /* Copiado exactamente de la vista de Flora */
    ...
    <div class="text-center mb-4">
        <h1 class="mb-4 text-white display-4">
            <i class="fas fa-leaf" style="color: white; margin-top: 30px;"></i>
            Bienvenido a la Fauna Hondureña
        </h1>
    </div>
    ...
    <div class="d-flex justify-content-end mb-4">
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                ...
                <li><a class="dropdown-item" href="{{ route('mamiferos.index') }}">Grupo de Mamíferos</a></li>
                ...
                <a href="{{ route('catalogo.show', $specie->id) }}" class="kb-gallery-item">
                    <figure>
                        ...
                        <figcaption>
                            ...
                            @if ($specie->category)
                                <span class="badge bg-success">{{ $specie->category->nombre }}</span>
                            @else
