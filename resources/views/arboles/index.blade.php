...
$items = [
    ...
    ['label' => 'Grupo de árboles']
];
$title = 'Sección Árboles';
@endphp
...
<div class="container mt-4">
    ...
    @if($especies->isEmpty())
        <p class="text-white text-center mt-3">No hay especies registradas en este grupo.</p>
    @else
...
@media (max-width: 1024px) {
    .kb-gallery-item { width: calc(33.33% - 20px); }
}

@media (max-width: 768px) {
    .kb-gallery-item { width: calc(50% - 20px); }
}

@media (max-width: 480px) {
    .kb-gallery-item { width: 100%; }
}
</style>
